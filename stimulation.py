...
def simulate():
    ...
    magnetic_field_strength = data['magnetic_field_strength']
    time_steps = data['time_steps']
    time_step_duration = data['time_step_duration']
    ...
    for step in range(time_steps):
        ...
        print(f"Step {step+1}: Calculated energy = {energy}, Resonance frequency = {resonance_frequency}")
